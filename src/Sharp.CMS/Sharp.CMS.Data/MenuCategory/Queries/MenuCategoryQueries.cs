...
namespace Sharp.CMS.Data.MenuCategory.Queries
{
    public class MenuCategoryQueries : IMenuCategoryQueries
    {
        ...
        public MenuCategoryQueries(SharpContext bugPointContext, IMemoryCache cache)
        {
        ...
        public EditMenuCategoriesViewModel GetCategoryByMenuCategoryIdForEdit(int? menuCategoryId)
        {
            try
            {
                var result = (from category in _sharpContext.MenuCategorys.AsNoTracking()
        ...
        {
            var categoryList = (from cat in _sharpContext.MenuCategorys
        ...
        public int GetCategoryCount(string menuCategoryName)
        {
            try
            {
                ...
                {
                    var result = (from category in _sharpContext.MenuCategorys
        ...
        public IQueryable<MenuCategoryGridViewModel> ShowAllMenusCategory(string sortColumn, string sortColumnDir, string search)
        {
            try
            {
                var queryableMenuMaster = (from menuCategory in _sharpContext.MenuCategorys
                                           join roleMaster in _sharpContext.RoleMasters on menuCategory.RoleId equals roleMaster.RoleId
        ...
        {
            var listofmenucategories = (from tempmenu in _sharpContext.MenuCategorys
