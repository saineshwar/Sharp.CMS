...
namespace Sharp.CMS.Data.MenuMaster.Queries
{
    public class MenuMasterQueries : IMenuMasterQueries
    {
        ...
        public MenuMasterQueries(SharpContext bugPointContext, IMemoryCache cache)
        {
        ...
        public bool CheckMenuNameExists(string menuName)
        {
            try
            {
                var result = (from menu in _sharpContext.MenuMasters
        ...
        public bool CheckMenuExists(string menuName, int? roleId, int? categoryId)
        {
            try
            {
                var result = (from menu in _sharpContext.MenuMasters.AsNoTracking()
        ...
        public IQueryable<MenuMasterGrid> ShowAllMenus(string sortColumn, string sortColumnDir, string search)
        {
            try
            {
                var queryableMenuMaster = (from menu in _sharpContext.MenuMasters
                                           join category in _sharpContext.MenuCategorys on menu.MenuCategoryId equals category.MenuCategoryId
                                           join roleMaster in _sharpContext.RoleMasters on menu.RoleId equals roleMaster.RoleId
        ...
        public EditMenuMasterViewModel GetMenuByMenuId(int? menuId)
        {
            try
            {
                var editmenu = (from menu in _sharpContext.MenuMasters
        ...
        {
            var listofactiveMenus = (from tempmenu in _sharpContext.MenuMasters
