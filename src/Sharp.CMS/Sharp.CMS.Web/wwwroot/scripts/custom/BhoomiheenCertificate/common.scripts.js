...
$(document).ready(function () {
    $("#LandHolderDistrictSelected").change(function () {
        var requestTalukaModel = { Districtcode: $("#LandHolderDistrictSelected").val() };
    ...
    $("#LandHolderTalukaSelected").change(function () {
        var requestVillageModel = { SubDistrictcode: $("#LandHolderTalukaSelected").val() };
        $.ajax({
            type: "POST",
