...
$(document).ready(function () {
    ...
    $("#MigrantAddress").hide(); $("#MigrantDetails").hide(); $("#BenefDetails").hide();
    ...
    $("#ddlmigdist_STSelected").change(function () {
        var requestTalukaModel = { Districtcode: $("#ddlmigdist_STSelected").val() };
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#ddlmigtaluka_STSelected").empty();
                $.each(data,
                    function (i) {
                        var optionhtml = '<option value="' + data[i].SubDistrictcode + '">' + data[i].SubDistrictname + '</option>';
                        $("#ddlmigtaluka_STSelected").append(optionhtml);
                    });
            }
        });
    });

    $("#ddlmigtaluka_STSelected").change(function () {
        var requestVillageModel = { SubDistrictcode: $("#ddlmigtaluka_STSelected").val() };
        $.ajax({
            type: "POST",
            url: "/Service/CommonDropdown/GetVillage",
            data: requestVillageModel,
            ...
            success: function (data) {
                $("#ddlmigvillage_STSelected").empty();
                $.each(data, function (i) {

                    var optionhtml = '<option value="' + data[i].Villagecode + '">' + data[i].Villagename + '</option>';
                    $("#ddlmigvillage_STSelected").append(optionhtml);
                });
            }
        });
...
function AddEducation() {
    ...
    if (txt_qualification == null || txt_qualification == "") {
        ...
        $.ajax({
            type: 'POST',
            url: '/Service/CasteCertificate/Insert_DataST',
            dataType: 'json',
            data: postdata,
            success: function (data) {
                debugger;
...
function deleteEducation(Number) {
    ...
    $.ajax({
        type: "POST",
        url: "/Service/CasteCertificate/Delete_DataST",
        dataType: 'json',
        data: requestModel,
        success: function (data) {
            debugger;
...
function ToggleTextBoxMigrDetail(add) {
    debugger;
    var value = add.split('__')[1]
    if (value == "Istrue") {
        $("#MigrantAddress").show();
