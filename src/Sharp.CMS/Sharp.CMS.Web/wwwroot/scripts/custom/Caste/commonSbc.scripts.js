...
$(document).ready(function () {
    $("#BenfiAddress").hide(); $("#benefit").hide(); $("#Detailsapplication").hide(); $("#Detailscertificate").hide(); $("#Detailscertificate1").hide(); $("#BenefDetails").hide();
...
function AddEducation() {
    ...
    if (txt_qualification == null || txt_qualification == "") {
        ...
        $.ajax({
            type: 'POST',
            url: '/Service/CasteCertificate/Insert_DataSBC',
            dataType: 'json',
            data: postdata,
            success: function (data) {
                debugger;
...
function deleteEducation(Number) {
    ...
    $.ajax({
        type: "POST",
        url: "/Service/CasteCertificate/Delete_DataSBC",
        dataType: 'json',
        data: requestModel,
        success: function (data) {
            debugger;
