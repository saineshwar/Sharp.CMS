...
$(document).ready(function () {
    ...
    $("#BenefDetails").hide(); $("#MigrantAddress").hide(); $("#MigrantDetails").hide();
    ...
    //    var CasteID = { Castecode: $("#CasteSelected").val() };

    //    $.ajax({
    //        type: "POST",
    //        url: "/Service/CasteCertificate/GetCategory",
    //        dataType: "json",
    //        data: CasteID,
    //        success: function (response) {
    //            if (response != null) {
    //                $("#txtcategory").empty();
    //                $('#txtcategory').val(response);
    //            }
    //            else {
...
function AddEducation() {
    ...
    if (txt_qualification == null || txt_qualification == "") {
        ...
        $.ajax({
            type: 'POST',
            url: '/Service/CasteCertificate/Insert_DataCentralSC',
            dataType: 'json',
            data: postdata,
            success: function (data) {
                if (data.length == 0) {
...
function deleteEducation(Number) {
    ...
    $.ajax({
        type: "POST",
        url: "/Service/CasteCertificate/Delete_DataCentralSC",
        dataType: 'json',
        data: requestModel,
        success: function (data) {
            if (data.length == 0) {
