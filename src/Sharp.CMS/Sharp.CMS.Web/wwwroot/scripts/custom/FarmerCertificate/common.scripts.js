...
$(document).ready(function () {
    $("#RelativeDistrictSelected").change(function () {
        var requestTalukaModel = { Districtcode: $("#RelativeDistrictSelected").val() };
    ...
    $("#RelativeTalukaSelected").change(function () {
        var requestVillageModel = { SubDistrictcode: $("#RelativeTalukaSelected").val() };
        $.ajax({
            type: "POST",
...
$("#RelativeSalutationSelected").change(function () {
    document.getElementById("RelativeSalutationSelectedText").value = $("#RelativeSalutationSelected option:selected").text();
});
